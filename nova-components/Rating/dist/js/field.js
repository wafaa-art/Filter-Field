...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-rating', __webpack_require__(3));
  Vue.component('detail-rating', __webpack_require__(6));
  Vue.component('form-rating', __webpack_require__(9));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_star_rating__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { StarRating: __WEBPACK_IMPORTED_MODULE_1_vue_star_rating___default.a },
    dat: function dat() {
        return {
            value: 0
        };
...
var render = function() {
  ...
  return _c("star-rating", {
    attrs: {
      id: _vm.field.name,
      name: _vm.field.name,
      rating: parseFloat(_vm.value) || 0,
      increment: _vm.increment,
      "max-rating": _vm.max,
      "show-rating": _vm.showRating,
      "read-only": true,
      "star-size": _vm.field["star-size"],
      "inactive-color": _vm.field["inactive-color"],
      "active-color": _vm.field["active-color"],
      "border-color": _vm.field["border-color"],
      "border-width": _vm.field["border-width"],
      padding: _vm.field["padding"],
      "rounded-corners": _vm.field["rounded-corners"],
      inline: _vm.field["inline"],
      glow: _vm.field["glow"],
      "glow-color": _vm.field["glow-color"],
      "text-class": _vm.field["text-class"]
    }
  })
}
var staticRenderFns = []
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_star_rating__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { StarRating: __WEBPACK_IMPORTED_MODULE_0_vue_star_rating___default.a },
    data: function data() {
        return {
            value: 0
        };
